...
part of 'flyverify_UIConfig.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

FlyVerifyUIConfig _$FlyVerifyUIConfigFromJson(Map<String, dynamic> json) =>
    FlyVerifyUIConfig()
      ..iOSConfig = json['iOSConfig'] == null
          ? null
          : FlyVerifyUIConfigIOS.fromJson(
              json['iOSConfig'] as Map<String, dynamic>)
      ..androidPortraitConfig = json['androidPortraitConfig'] == null
          ? null
          : FlyVerifyUIConfigAndroid.fromJson(
...
Map<String, dynamic> _$FlyVerifyUIConfigToJson(FlyVerifyUIConfig instance) {
...
FlyVerifyUIConfigIOS _$FlyVerifyUIConfigIOSFromJson(
    ...
    FlyVerifyUIConfigIOS()
      ...
      ..preferredStatusBarStyle = $enumDecodeNullable(
      ...
      ..modalTransitionStyle = $enumDecodeNullable(
          _$iOSModalTransitionStyleEnumMap, json['modalTransitionStyle'])
      ..modalPresentationStyle = $enumDecodeNullable(
      ...
      ..privacyWebVCPreferredStatusBarStyle = $enumDecodeNullable(
          _$iOSStatusBarStyleEnumMap,
          json['privacyWebVCPreferredStatusBarStyle'])
      ..privacyWebVCModalPresentationStyle = $enumDecodeNullable(
          _$iOSModalPresentationStyleEnumMap,
          json['privacyWebVCModalPresentationStyle'])
      ..overrideUserInterfaceStyle = $enumDecodeNullable(
      ...
      ..loginBtnCornerRadius =
          (json['loginBtnCornerRadius'] as num?)?.toDouble()
      ..loginBtnBorderColor = json['loginBtnBorderColor'] as String?
      ..loginBtnBgImgNames = (json['loginBtnBgImgNames'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList()
      ..logoHidden = json['logoHidden'] as bool?
      ..logoImageName = json['logoImageName'] as String?
      ..logoCornerRadius = (json['logoCornerRadius'] as num?)?.toDouble()
      ..numberColor = json['numberColor'] as String?
      ..numberBgColor = json['numberBgColor'] as String?
      ..numberTextAlignment = $enumDecodeNullable(
          _$iOSTextAlignmentEnumMap, json['numberTextAlignment'])
      ..phoneCorner = (json['phoneCorner'] as num?)?.toDouble()
      ..phoneBorderWidth = (json['phoneBorderWidth'] as num?)?.toDouble()
      ...
      ..privacyLineSpacing = (json['privacyLineSpacing'] as num?)?.toDouble()
      ..privacyTextAlignment = $enumDecodeNullable(
          _$iOSTextAlignmentEnumMap, json['privacyTextAlignment'])
      ..privacySettings = (json['privacySettings'] as List<dynamic>?)
          ?.map((e) => e == null
              ? null
              : FlyVerifyUIConfigIOSPrivacyText.fromJson(
      ...
      ..sloganTextAlignment = $enumDecodeNullable(
          _$iOSTextAlignmentEnumMap, json['sloganTextAlignment'])
      ..sloganCorner = (json['sloganCorner'] as num?)?.toDouble()
      ..sloganBorderWidth = (json['sloganBorderWidth'] as num?)?.toDouble()
      ..sloganBorderColor = json['sloganBorderColor'] as String?
      ..widgets = (json['widgets'] as List<dynamic>?)
          ?.map((e) => e == null
              ? null
              : FlyVerifyUIConfigIOSCustomView.fromJson(
                  e as Map<String, dynamic>))
          .toList()
      ..portraitLayouts = json['portraitLayouts'] == null
          ? null
          : FlyVerifyUIConfigIOSCustomLayouts.fromJson(
              json['portraitLayouts'] as Map<String, dynamic>)
      ..landscapeLayouts = json['landscapeLayouts'] == null
          ? null
          : FlyVerifyUIConfigIOSCustomLayouts.fromJson(
              json['landscapeLayouts'] as Map<String, dynamic>);

Map<String, dynamic> _$FlyVerifyUIConfigIOSToJson(
    FlyVerifyUIConfigIOS instance) {
  final val = <String, dynamic>{};
  ...
  val['manualDismiss'] = instance.manualDismiss;
...
FlyVerifyUIConfigIOSPrivacyText _$FlyVerifyUIConfigIOSPrivacyTextFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$FlyVerifyUIConfigIOSPrivacyTextToJson(
    FlyVerifyUIConfigIOSPrivacyText instance) {
  final val = <String, dynamic>{};
...
FlyVerifyUIConfigIOSCustomView _$FlyVerifyUIConfigIOSCustomViewFromJson(
        Map<String, dynamic> json) =>
    FlyVerifyUIConfigIOSCustomView(
      ...
      ..portraitLayout = json['portraitLayout'] == null
          ? null
          : FlyVerifyUIConfigIOSLayout.fromJson(
...
Map<String, dynamic> _$FlyVerifyUIConfigIOSCustomViewToJson(
    FlyVerifyUIConfigIOSCustomView instance) {
  final val = <String, dynamic>{};
...
FlyVerifyUIConfigIOSCustomNavButton
    _$FlyVerifyUIConfigIOSCustomNavButtonFromJson(Map<String, dynamic> json) =>
        FlyVerifyUIConfigIOSCustomNavButton(
          ...
          ..isBodyFont = json['isBodyFont'] as bool
          ..normalImage = json['normalImage'] as String?
          ..normalBackgroundImage = json['normalBackgroundImage'] as String?
          ..highlightedImage = json['highlightedImage'] as String?
          ..disabledImage = json['disabledImage'] as String?
          ..selectedImage = json['selectedImage'] as String?
          ..highlightedBackgroundImage =
              json['highlightedBackgroundImage'] as String?
          ..disabledBackgroundImage = json['disabledBackgroundImage'] as String?
          ..selectedBackgroundImage = json['selectedBackgroundImage'] as String?
          ..widgetType = $enumDecodeNullable(
              _$iOSCustomWidgetTypeEnumMap, json['widgetType'])
          ..navPosition = $enumDecodeNullable(
              _$iOSCustomWidgetNavPositionEnumMap, json['navPosition']);

Map<String, dynamic> _$FlyVerifyUIConfigIOSCustomNavButtonToJson(
    FlyVerifyUIConfigIOSCustomNavButton instance) {
  final val = <String, dynamic>{};
  ...
  writeNotNull('titleColor', instance.titleColor);
  writeNotNull('titleFontSize', instance.titleFontSize);
  val['isBodyFont'] = instance.isBodyFont;
  writeNotNull('normalImage', instance.normalImage);
  writeNotNull('normalBackgroundImage', instance.normalBackgroundImage);
  writeNotNull('highlightedImage', instance.highlightedImage);
  writeNotNull('disabledImage', instance.disabledImage);
  writeNotNull('selectedImage', instance.selectedImage);
  writeNotNull(
      'highlightedBackgroundImage', instance.highlightedBackgroundImage);
  writeNotNull('disabledBackgroundImage', instance.disabledBackgroundImage);
  writeNotNull('selectedBackgroundImage', instance.selectedBackgroundImage);
...
FlyVerifyUIConfigIOSCustomButton _$FlyVerifyUIConfigIOSCustomButtonFromJson(
        Map<String, dynamic> json) =>
    FlyVerifyUIConfigIOSCustomButton(
      json['widgetID'] as int?,
    )
      ..cornerRadius = (json['cornerRadius'] as num?)?.toDouble()
      ..backgroundColor = json['backgroundColor'] as String?
      ...
      ..selectedBackgroundImage = json['selectedBackgroundImage'] as String?
      ..widgetType =
          $enumDecodeNullable(_$iOSCustomWidgetTypeEnumMap, json['widgetType']);

Map<String, dynamic> _$FlyVerifyUIConfigIOSCustomButtonToJson(
    FlyVerifyUIConfigIOSCustomButton instance) {
  final val = <String, dynamic>{};
...
FlyVerifyUIConfigIOSCustomImageView
    _$FlyVerifyUIConfigIOSCustomImageViewFromJson(Map<String, dynamic> json) =>
        FlyVerifyUIConfigIOSCustomImageView(
          json['widgetID'] as int?,
        )
          ..cornerRadius = (json['cornerRadius'] as num?)?.toDouble()
          ...
          ..contentMode = $enumDecodeNullable(
              _$iOSUIViewContentModeEnumMap, json['contentMode'])
          ..widgetType = $enumDecodeNullable(
              _$iOSCustomWidgetTypeEnumMap, json['widgetType']);

Map<String, dynamic> _$FlyVerifyUIConfigIOSCustomImageViewToJson(
    FlyVerifyUIConfigIOSCustomImageView instance) {
  final val = <String, dynamic>{};
  ...
  writeNotNull(
      'contentMode', _$iOSUIViewContentModeEnumMap[instance.contentMode]);
  writeNotNull('widgetType', _$iOSCustomWidgetTypeEnumMap[instance.widgetType]);
  return val;
}

const _$iOSUIViewContentModeEnumMap = {
  iOSUIViewContentMode.scaleToFill: 0,
  iOSUIViewContentMode.scaleAspectFit: 1,
  iOSUIViewContentMode.scaleAspectFill: 2,
};

FlyVerifyUIConfigIOSCustomLabel _$FlyVerifyUIConfigIOSCustomLabelFromJson(
        Map<String, dynamic> json) =>
    FlyVerifyUIConfigIOSCustomLabel(
      json['widgetID'] as int?,
    )
      ..cornerRadius = (json['cornerRadius'] as num?)?.toDouble()
      ..backgroundColor = json['backgroundColor'] as String?
      ...
      ..isBodyFont = json['isBodyFont'] as bool
      ..textAlignment =
          $enumDecodeNullable(_$iOSTextAlignmentEnumMap, json['textAlignment'])
      ..widgetType =
          $enumDecodeNullable(_$iOSCustomWidgetTypeEnumMap, json['widgetType']);

Map<String, dynamic> _$FlyVerifyUIConfigIOSCustomLabelToJson(
    FlyVerifyUIConfigIOSCustomLabel instance) {
  final val = <String, dynamic>{};
...
FlyVerifyUIConfigIOSCustomLayouts _$FlyVerifyUIConfigIOSCustomLayoutsFromJson(
        Map<String, dynamic> json) =>
    FlyVerifyUIConfigIOSCustomLayouts()
      ...
      ..checkBoxLayout = json['checkBoxLayout'] == null
          ? null
          : FlyVerifyUIConfigIOSPrivacyCheckBoxLayout.fromJson(
              json['checkBoxLayout'] as Map<String, dynamic>);

Map<String, dynamic> _$FlyVerifyUIConfigIOSCustomLayoutsToJson(
    FlyVerifyUIConfigIOSCustomLayouts instance) {
  final val = <String, dynamic>{};
...
FlyVerifyUIConfigIOSLayout _$FlyVerifyUIConfigIOSLayoutFromJson(
        Map<String, dynamic> json) =>
    FlyVerifyUIConfigIOSLayout()
      ..layoutTop = (json['layoutTop'] as num?)?.toDouble()
      ..layoutLeading = (json['layoutLeading'] as num?)?.toDouble()
      ..layoutBottom = (json['layoutBottom'] as num?)?.toDouble()
      ..layoutTrailing = (json['layoutTrailing'] as num?)?.toDouble()
      ..layoutCenterX = (json['layoutCenterX'] as num?)?.toDouble()
      ..layoutCenterY = (json['layoutCenterY'] as num?)?.toDouble()
      ..layoutWidth = (json['layoutWidth'] as num?)?.toDouble()
      ..layoutHeight = (json['layoutHeight'] as num?)?.toDouble();

Map<String, dynamic> _$FlyVerifyUIConfigIOSLayoutToJson(
    FlyVerifyUIConfigIOSLayout instance) {
  final val = <String, dynamic>{};
...
FlyVerifyUIConfigIOSPrivacyCheckBoxLayout
    _$FlyVerifyUIConfigIOSPrivacyCheckBoxLayoutFromJson(
            Map<String, dynamic> json) =>
        FlyVerifyUIConfigIOSPrivacyCheckBoxLayout()
          ..layoutTop = (json['layoutTop'] as num?)?.toDouble()
          ..layoutLeading = (json['layoutLeading'] as num?)?.toDouble()
          ...
          ..layoutWidth = (json['layoutWidth'] as num?)?.toDouble()
          ..layoutHeight = (json['layoutHeight'] as num?)?.toDouble()
          ..layoutToSuperView = json['layoutToSuperView'] as bool?
          ..layoutRightSpaceToPrivacyLeft =
              (json['layoutRightSpaceToPrivacyLeft'] as num?)?.toDouble()
          ..layoutLeftSpaceToPrivacyRight =
              (json['layoutLeftSpaceToPrivacyRight'] as num?)?.toDouble();

Map<String, dynamic> _$FlyVerifyUIConfigIOSPrivacyCheckBoxLayoutToJson(
    FlyVerifyUIConfigIOSPrivacyCheckBoxLayout instance) {
  final val = <String, dynamic>{};
  ...
  writeNotNull('layoutWidth', instance.layoutWidth);
  writeNotNull('layoutHeight', instance.layoutHeight);
  writeNotNull('layoutToSuperView', instance.layoutToSuperView);
  writeNotNull(
      'layoutRightSpaceToPrivacyLeft', instance.layoutRightSpaceToPrivacyLeft);
  writeNotNull(
      'layoutLeftSpaceToPrivacyRight', instance.layoutLeftSpaceToPrivacyRight);
  return val;
}

FlyVerifyUIConfigAndroid _$FlyVerifyUIConfigAndroidFromJson(
        Map<String, dynamic> json) =>
    FlyVerifyUIConfigAndroid()
      ...
      ..navCloseImgScaleType = $enumDecodeNullable(
      ...
      ..agreementPageTitleStringId =
          json['agreementPageTitleStringId'] as String?
      ...
      ..agreementPageCloseImgHidden =
          json['agreementPageCloseImgHidden'] as bool?
      ..agreementPageCloseImgWidth = json['agreementPageCloseImgWidth'] as int?
      ..agreementPageCloseImgHeight =
          json['agreementPageCloseImgHeight'] as int?
...
Map<String, dynamic> _$FlyVerifyUIConfigAndroidToJson(
    FlyVerifyUIConfigAndroid instance) {
  final val = <String, dynamic>{};
...
AndroidCustomCheckBox _$AndroidCustomCheckBoxFromJson(
    ...
    AndroidCustomCheckBox()
      ...
      ..checkboxOffsetY = json['checkboxOffsetY'] as int?
      ..checkboxOffsetBottomY = json['checkboxOffsetBottomY'] as int?
      ..checkboxScaleX = json['checkboxScaleX'] as String?
      ..checkboxScaleY = json['checkboxScaleY'] as String?
      ..checkedImgName = json['checkedImgName'] as String?
      ..uncheckedImgName = json['uncheckedImgName'] as String?
      ..checkboxWidth = json['checkboxWidth'] as int?
      ..checkboxHeight = json['checkboxHeight'] as int?;
...
AndroidCustomPrivacy _$AndroidCustomPrivacyFromJson(
        Map<String, dynamic> json) =>
...
AndroidCustomView _$AndroidCustomViewFromJson(Map<String, dynamic> json) =>
    AndroidCustomView()
      ..viewTag = json['viewTag'] as String?
